...
- **Directories:** docs/, docs/de/, docs/reports/, root files
...
4. **docs/administration.md**
   ...
   - **Причина:** Полностью дублирует docs/admin-guide.md (версия 8.0, более
     актуальная)
   - **Ценность:** Нулевая (есть актуальная версия admin-guide.md)
   - **Действие:** Архивировать и удалить
   - **Примечание:** admin-guide.md содержит все обновления + новые разделы

5. **docs/monitoring-troubleshooting-v2.md**
   - **Дата:** 2025-09-19
   - **Размер:** 16KB
   - **Причина:** Информация интегрирована в docs/monitoring-guide.md
...
cp docs/monitoring-troubleshooting-v2.md .config-backup/docs-archive-20251024/
...
rm docs/monitoring-troubleshooting-v2.md
...
diff -r docs/ docs/de/ --exclude="*.md" | grep "Only in"
```
