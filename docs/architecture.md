...
> **Версия документа:** 8.0 **Дата обновления:** 2025-08-29 **Статус:** Production Ready (Полностью
> функциональная система с исправленными Cloudflare туннелями + Актуализированная документация +
> Комплексная диагностика)

## 📋 Обзор архитектуры

ERNI-KI представляет собой современную микросервисную AI платформу, построенную на принципах
контейнеризации, безопасности и масштабируемости. Система состоит из **29 взаимосвязанных сервисов
ERNI-KI**, включая компоненты LiteLLM, Docling, MCP Server, полный мониторинг стек с 35+ активными
targets, ollama-exporter для AI метрик, nginx-exporter для веб-аналитики и централизованное
логирование через Fluent-bit. Дополнительно система включает 9 внешних сервисов (RAGFlow,
...
- **8 экспортеров**: node, postgres, redis, nginx, ollama, nvidia, cadvisor, blackbox
...
- Всего 6 моделей: qwen2.5:0.5b, qwen2.5-coder:1.5b, phi4-mini-reasoning:3.8b, gemma3n:e4b,
...
**📝 Примечание**: Данная архитектура оптимизирована для production использования с акцентом на
