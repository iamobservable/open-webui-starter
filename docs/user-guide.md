...
> **Версия документа:** 8.0 **Дата обновления:** 2025-08-29 **Целевая аудитория:** Конечные
> пользователи

## 🎯 Введение

ERNI-KI — это современная AI-платформа на базе OpenWebUI v0.6.26, предоставляющая удобный
веб-интерфейс для работы с языковыми моделями. Система поддерживает AI-чат, поиск в интернете,
обработку документов и голосовое взаимодействие с GPU ускорением и enterprise-grade
производительностью.
...
_Документ обновлен для ERNI-KI v8.0 с учетом восстановления системы, исправления Cloudflare туннелей
и актуализации всех компонентов._
