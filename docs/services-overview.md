...
> обновления**: 2025-10-02 **Версия системы**: Production Ready v12.0
> **Статус**: ✅ Все 30 сервисов работают (30/30 Healthy)
...
| Сервис         | Статус     | Порты                  | Конфигурация | Переменные окружения | Тип конфигурации | Примечания                                                                                                 |
| -------------- | ---------- | ---------------------- | ------------ | -------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------- |
| **📄 docling** | ✅ Healthy | `5001,8080` (internal) | ❌ Нет       | `env/docling.env`    | ENV              | Docling • OCR: EasyOCR (EN, DE, FR, IT) • Memory: 12GB limit • CPU: 8 cores • CUDA отключен (Quadro P2200) |
