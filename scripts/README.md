...
Коллекция скриптов для упрощения развертывания, управления и мониторинга AI платформы ERNI-KI.
...
**Назначение:** Комплексная настройка системы с пользовательским вводом
...
**Назначение:** Автоматический запуск с настройками по умолчанию
...
**Назначение:** Комплексная диагностика всех компонентов
...
- **Архитектура системы:** [docs/service-architecture-diagram.md](../docs/service-architecture-diagram.md)
- **Устранение неполадок:** [docs/FIXES-AND-IMPROVEMENTS.md](../docs/FIXES-AND-IMPROVEMENTS.md)
...
**Время отклика:** Обычно в течение 24 часов
